...
struct GeneralSettingsView: View {
    ...
    private var outputLanguageSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("When set, Megaphone translates your speech into the selected language.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
...
struct PromptsSettingsView: View {
    ...
    private var instructionGuardSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("When enabled, Megaphone retries or falls back to the literal transcript if post-processing looks like it answered the dictated text instead of cleaning it.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
    ...
    private func runSystemPromptTest() {
        ...
        let context = AppContext(
            ...
            bundleIdentifier: "com.kuberwastaken.megaphone",
