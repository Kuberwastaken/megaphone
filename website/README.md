...
- The fixed navigation is a restrained liquid-glass surface with a pointer-following specular highlight and a refractive lens that follows the current section. Its destinations stay intentionally conventional: Overview, Features, Privacy, GitHub, and Download.
