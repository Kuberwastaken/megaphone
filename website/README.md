...
- The fixed navigation uses a standalone liquid-glass renderer: generated canvas displacement/specular maps feed SVG backdrop filters for both the bar and active lens. The lens supports press, drag, overshoot, and snap interactions, follows the current section, and retains conventional destinations: Overview, Features, Privacy, GitHub, and Download.
