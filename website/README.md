...
- The feature explorer mirrors Megaphone's native SwiftUI sidebar, Settings cards, Dictionary fields, toggles, and cleanup controls. Mail and Slack alternate automatically to demonstrate active-window context, while the animated Hey Megaphone flow makes the on-device Foundation Models handoff explicit.
