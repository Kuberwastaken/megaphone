...
- The feature bento demonstrates streaming Smart Cleanup, language switching, the native Dictionary model, and locally learned Memory. Mail and Slack alternate automatically to demonstrate active-window context, while the animated Hey Megaphone flow makes the on-device Foundation Models handoff explicit.
